...
namespace CarRent
{
    public partial class BorrowManagement : System.Web.UI.Page
    {
        // 连接数据库所需要的字符串
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            string query = "insert into borrow(CarID, IDCard, BorrowTime, ReturnTime) values('" + idcard + "','" + name + "','" + telephone + "','" + address + "');";
            ...
            query = "delete from car where CarID = '" + idcard + "';";
            myConnection = new MySqlConnection(connectionString);
            myCommand = new MySqlCommand(query, myConnection);
            myConnection.Open();
            myCommand.ExecuteNonQuery();
